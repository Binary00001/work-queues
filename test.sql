...
-- SELECT * FROM MrplTable
-- WHERE MRP_PARTREF LIKE '%112W550239%'
-- AND MRP_PARTPRODCODE LIKE '%%'
-- AND MRP_PARTDATERQD BETWEEN CAST('01/01/95' AS DATE) AND CAST('12/31/24' AS DATE)
-- AND MRP_TYPE <> 6
-- AND MRP_TYPE <> 5;
...
USE master
GO 
xp_readerrolog 0, 1, N'Server is listenting on'
GO